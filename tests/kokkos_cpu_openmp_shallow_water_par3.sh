...
sed -i 's/Kokkos::View<double \*\*>/Kokkos::View<double **, Kokkos::OpenMP>/g' ShallowWater_par3.cc
sed -i 's/Kokkos::MDRangePolicy<Kokkos::Rank<2>>/Kokkos::MDRangePolicy<Kokkos::OpenMP, Kokkos::Rank<2>>/g' ShallowWater_par3.cc
sed -i 's/Kokkos::RangePolicy<>/Kokkos::RangePolicy<Kokkos::OpenMP>/g' ShallowWater_par3.cc
sed -i 's/KOKKOS_LAMBDA/[=]/g' ShallowWater_par3.cc
