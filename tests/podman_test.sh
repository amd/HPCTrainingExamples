...
podman ${PODMAN_STORAGE_ARGS} run --device=/dev/dri --device=/dev/kfd  --network=host --ipc=host --group-add keep-groups -v $HOME:/workdir --workdir /workdir docker://rocm/dev-ubuntu-24.04:7.2.4 rocminfo
