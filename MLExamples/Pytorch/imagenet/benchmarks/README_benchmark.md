...
```bash
sbatch submit_ddp_bench.batch               # recommended: module + ddp_bench_sweep.sh (comm% metrics)
sbatch submit_imagenet_uv.batch             # self-contained uv venv + upstream main.py sweep
