        ...
        REAL(KIND=rk), DIMENSION(:), ALLOCATABLE   :: y,x, res_arr
        ...
        ALLOCATE(y(1:n), &
         ...
         !$OMP TARGET TEAMS DISTRIBUTE DEFAULT(NONE) PRIVATE(temp,i,j) SHARED(A,x,y,res_arr)  MAP(to: A,x,y) &
         !$OMP MAP(from:res_arr)
         DO i=1,n
           temp = 0.0_rk
