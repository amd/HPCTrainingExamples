...
```bash
rocprof-compute profile -n block_32x32_roof --roof-only --device 0 -k compute_rhs --iteration-multiplexing -- ./shallow
rocprof-compute analyze -p workloads/block_32x32_roof/0
```
