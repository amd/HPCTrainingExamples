...
| 8 | [Profiling communication & compute](08-profiling.md) | Hub + per-profiler step-by-step [guides](profilers/README.md) — Score-P, rocprofv3, Advanced Thread Trace, rocprof-compute, rocprofiler-systems, TAU, HPCToolkit, likwid, AMD uProf, roofline-extractor, rocBudAI, Linux perf, cachegrind — and perf_events security |
